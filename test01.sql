...
insert into Student(StudentName, Age, DateOfBirth)
	values
		(N'Đinh Quang Anh', 22, '19990811')
go
-- Sửa
update Student set DateOfBirth = '19990711' where StudentName = N'Đinh Quang Anh'
go
-- Xoá
delete from Student where StudentName = N'Đinh Quang Anh'
go 
...
insert into Student(StudentName, Age, DateOfBirth, ClassID, StudentID)
	values
		(N'Đinh Quang Anh', 22, '19990711', 'T09', 'TH005'),
		(N'Vũ Viết Quý', 18, '20031210', 'T09', 'TH013'),
		(N'Đỗ Hà Linh', 18, '20031107', 'T08', 'TH006')
go
select * from Student
select * from Class